...
public class WalletController {
	...
	public String deposit(@PathVariable String mobileno, @PathVariable String password,
	...
	public String withdraw(@PathVariable String mobileno, @PathVariable String password,
			@PathVariable BigDecimal amount) {
	...
	public String fundtrasfer(@PathVariable String targetmobileno, @PathVariable String sourcemobileno,
			@PathVariable String password, @PathVariable BigDecimal amount) {
